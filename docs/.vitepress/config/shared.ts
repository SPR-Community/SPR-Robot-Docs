...
export const shared = defineConfig({
  ...
  head: [
    ...
    ['meta', { property: 'og:title', content: 'BotK - Shanshui Community Docs | 机器人小K·山水画路·文档' }],
    ['meta', { property: 'og:site_name', content: '机器人小K · 使用文档' }],
    ['meta', { property: 'og:image', content: 'https://static.shanshui.site/logo.ico' }],
    ['meta', { property: 'og:url', content: 'https://spr-community.github.io/SPR-Robot-Docs' }],
